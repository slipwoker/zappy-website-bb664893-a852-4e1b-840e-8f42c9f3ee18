document.addEventListener('DOMContentLoaded', function() {
        ...
        const validateField = (input) => {
            ...
            if (input.hasAttribute('minlength') && value) {
                ...
                if (value.length < minLength) {
                    showError(input, (isRTL ? 'يجب أن يكون ' + minLength + ' أحرف على الأقل' : 'Must be at least ' + minLength + ' characters'));
                    return false;
                }
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = isRTL ? 'جارٍ الإرسال...' : 'Sending...';
                    
                    setTimeout(() => {
                        submitButton.textContent = isRTL ? 'تم الإرسال!' : 'Sent!';
    ...
    if (animatedElements.length > 0) {
        ...
        style.textContent = `
            ...
            .fade-in-left {
                transform: translateX(${isRTL ? '30px' : '-30px'});
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bb664893-a852-4e1b-840e-8f42c9f3ee18',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bb664893-a852-4e1b-840e-8f42c9f3ee18';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bb664893-a852-4e1b-840e-8f42c9f3ee18';
